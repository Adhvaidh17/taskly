...
class RecoveredChatCacheService extends ChatCacheService {
  static const List<String> _assets = [
    'assets/recovered_chat/0eca4074-e98b-4407-845e-75291e9cb8e3_conversations_v43.json',
    'assets/recovered_chat/1088ab35-0c03-4a73-97a5-b82a6688f8b7_conversations_v43.json',
    'assets/recovered_chat/0eca4074-e98b-4407-845e-75291e9cb8e3_channel_4_messages_v43.json',
    'assets/recovered_chat/0eca4074-e98b-4407-845e-75291e9cb8e3_channel_21_messages_v43.json',
    'assets/recovered_chat/0eca4074-e98b-4407-845e-75291e9cb8e3_channel_22_messages_v43.json',
    'assets/recovered_chat/0eca4074-e98b-4407-845e-75291e9cb8e3_channel_25_messages_v43.json',
    'assets/recovered_chat/1088ab35-0c03-4a73-97a5-b82a6688f8b7_channel_4_messages_v43.json',
    'assets/recovered_chat/1088ab35-0c03-4a73-97a5-b82a6688f8b7_channel_23_messages_v43.json',
  ];
  ...
  Future<List<ConversationItem>> readConversations() async {
    ...
    if (result.isNotEmpty) await super.writeConversations(result);
    return result;
  }
  ...
  Future<List<Map<String, dynamic>>> readMessages(int channelId) async {
    ...
    if (result.isNotEmpty) await super.writeMessages(channelId, result);
    return result;
  }
