...
class ChatInfoScreenV61 extends StatefulWidget {
  const ChatInfoScreenV61({
    super.key,
  ...
  @override
  State<ChatInfoScreenV61> createState() => _ChatInfoScreenV61State();
}

class _ChatInfoScreenV61State extends State<ChatInfoScreenV61> {
              ...
              children: [
                ListTile(
                  ...
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => MediaLinksDocsScreenV61(
...
class _QuickActionV61 extends StatelessWidget {
  const _QuickActionV61({
    required this.icon,
    required this.label,
    required this.onTap,
  });
...
class MediaLinksDocsScreenV61 extends StatefulWidget {
  const MediaLinksDocsScreenV61({super.key, required this.database, required this.channelId});
  final LocalChatDatabase database;
  final int channelId;

  @override
  State<MediaLinksDocsScreenV61> createState() => _MediaLinksDocsScreenV61State();
}

class _MediaLinksDocsScreenV61State extends State<MediaLinksDocsScreenV61> {
  String _tab = 'media';
